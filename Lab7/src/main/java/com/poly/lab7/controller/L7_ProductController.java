...
import com.poly.lab7.service.L5_SessionService;
...
@Controller
public class L7_ProductController {
    @Autowired
    ProductDAO dao;
    @Autowired
    L5_SessionService session;
    ...
    public String searchAndPage(
        ...
        return "lab7/product/search-and-page";
    }
}
